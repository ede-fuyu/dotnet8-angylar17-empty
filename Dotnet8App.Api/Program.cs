...
try
{
    ...
    var columnOptions = new ColumnOptions
    {
        AdditionalColumns = new Collection<SqlColumn>
        {
            ...
            new() {ColumnName = "RequestUri", DataType = SqlDbType.NVarChar, DataLength = -1},
            new() {ColumnName = "StatusCodes", DataType = SqlDbType.Int},
        }
    };
    ...
    Log.Logger = new LoggerConfiguration()
        ...
        .MinimumLevel.Override("Dotnet8App", LogEventLevel.Warning)
    ...
    app.UseMiddleware<AppLogsMiddleware>();
